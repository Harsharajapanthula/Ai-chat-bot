...
//URL=https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyDFmULfhuh199rHaAF_HhFcFT5fw0Kk-7k"
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function generateResponse(prompt) {
    const response = await fetch(
      `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyDFmULfhuh199rHaAF_HhFcFT5fw0Kk-7k`,
      {
        method: "POST",
        headers: {
